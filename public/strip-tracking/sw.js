...
const PRECACHE_URLS = [
  '/strip-tracking/',
  '/strip-tracking/manifest.json',
  '/strip-tracking/icon-192.png',
  '/strip-tracking/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/strip-tracking/manifest.json';
}
